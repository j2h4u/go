...
func main() {
	...
	// init a map with extract operators
	jsonFieldCollection := jsonFieldCollection{
		"GHS 5s":      jsonField{ExtractOperation: ".STATS.[1].GHS 5s"},      // "5904.657"
		"GHS av":      jsonField{ExtractOperation: ".STATS.[1].GHS av"},      // 5847.82
		"chain power": jsonField{ExtractOperation: ".STATS.[1].chain_power"}, // "456.78 (AB)"
		"chain_rate1": jsonField{ExtractOperation: ".STATS.[1].chain_rate1"}, // ""
	}
